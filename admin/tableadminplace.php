              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    <a class="btn btn-link text-danger text-gradient px-3 mb-0" href="../api/deleteplace.php?PID=<?php echo $row['PID'] ?>&type=admin"><i class="far fa-trash-alt me-2"></i>Delete</a><br>
